...
export default function SkillsClient() {
  return (
    <motion.div className="w-full text-white text-lg z-20 relative top-96 md:bottom-0 px-8 lg:px-52 xl:px-80 py-4 place-items-center grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 lg:gap-32">
      {skills.map((item, i) => {
